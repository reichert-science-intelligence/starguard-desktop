...
try:
    ...
    if df.empty:
        ...
        st.markdown("---")
        st.markdown("<h2 style='text-align: center;'>📋 Detailed Data Tables by Dimension</h2>", unsafe_allow_html=True)
        
        # Centered tab selection using radio buttons (guaranteed to center)
        st.markdown("<div style='display: flex; justify-content: center; margin: 1rem 0;'>", unsafe_allow_html=True)
        selected_tab = st.radio(
            "Select View",
            ["💰 Budget Analysis", "📊 Variance Analysis", "🎯 Status Breakdown", "📈 Complete Dataset"],
            horizontal=True,
            label_visibility="collapsed"
        )
        st.markdown("</div>", unsafe_allow_html=True)
        
        # Add CSS to center radio buttons
        st.markdown("""
        <style>
        ...
        if selected_tab == "💰 Budget Analysis":
        ...
        elif selected_tab == "📊 Variance Analysis":
        ...
        elif selected_tab == "🎯 Status Breakdown":
