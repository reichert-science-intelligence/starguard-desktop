...
try:
    ...
    if df.empty:
        ...
        selected_tab = st.radio(
            "Select View",
            ["📈 Trend Analysis", "💰 Financial Trends", "📊 Performance Trends", "📈 Complete Dataset"],
            horizontal=True,
            label_visibility="collapsed",
            key="tabs_monthly_trend"
        )
        ...
        if selected_tab == "📈 Trend Analysis":
        ...
        elif selected_tab == "📊 Performance Trends":
