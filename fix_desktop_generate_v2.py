#!/usr/bin/env python3
"""
fix_desktop_generate_v2.py — Add Claude AI Generate button to HEDIS Gap panel
...
def main():
    print("Applying Desktop Generate patches...")
    ...
    if HEDIS_GAP_UI_NEW.strip() in ui_text:
        ...
        print("  Expected placeholder: 'Paste Claude-generated care gap recommendation...'")
    ...
    if "gap_show_loading" in app_text and "gap_set_rec" in app_text:
        ...
        print("[WARN] JS anchor not found (cloud_status_css + ui.tags.meta)")
    ...
    print("\nDone. Restart: shiny run app.py --port 8080 --reload")
